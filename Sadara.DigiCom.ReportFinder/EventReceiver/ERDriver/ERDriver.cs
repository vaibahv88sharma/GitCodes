...
namespace Sadara.DigiCom.ReportFinder.EventReceiver.ERDriver
{
    /// <summary>
    /// List Item Events
    /// </summary>
    public class ERDriver : SPItemEventReceiver
    {
        /// <summary>
        /// An item was added.
        /// </summary>
        public override void ItemAdded(SPItemEventProperties properties)
        {
            ...
            try
            {
                ...
                string Field = Constants.ODMSDriver_FIELDS_DriverID;
