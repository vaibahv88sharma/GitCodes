...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewRequirementDetails.ascx.cs" Inherits="Sadara.DigiCom.ReportFinder.WebParts.ViewRequirementDetails.ViewRequirementDetails" %>
<div>
