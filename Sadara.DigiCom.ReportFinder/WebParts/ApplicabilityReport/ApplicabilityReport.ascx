...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ApplicabilityReport.ascx.cs" Inherits="Sadara.DigiCom.ReportFinder.WebParts.ApplicabilityReport.ApplicabilityReport" %>
                            ...
                            <table style="width:100%">
                                <tr style="width:100%">                                    
                                    ...
                                    <td style="width:30%">                                        
                                        ...
                                        <asp:CheckBox id="selectApplicability" runat="server" />
                                    </td>                                    
                                </tr>
                            </table>
                         </li>
...
<asp:Button ID="View_Requirements" CommandName="View Requirements" runat="server" Text="View Requirements" OnClick="Unnamed_Click" />
</div>
