...
<br />--%>
                            <div class="row">
                            <div class="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4 well">
                                <span style="font-weight: bold; color: blue; font-style: italic;">Justification for Mobile</span>
                            </div>
                                </div>
                                ...
                                <div id="justificationGroup1" class="col-lg-offset-5 col-md-offset-5">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-5 col-md-5 col-lg-5">
                                            ...
                                            <select id="typrOfUse" name="typrOfUse" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-5 col-md-5 col-lg-5">
                                            ...
                                            <select id="timeWorkedOfCampus" name="timeWorkedOfCampus" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-5 col-md-5 col-lg-5">
                                            ...
                                            <select id="dataUse" name="dataUse" class="form-control">
                                                <option value="Light">Light</option>
                                                <option value="Medium">Medium</option>
                                                <option value="Heavy">Heavy</option>
                                            </select>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-5 col-md-5 col-lg-5">
                                            ...
                                            <select id="emailRequired" name="emailRequired" class="form-control">
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
                                        </div>
...
<%--                            <div class="form-group">
                            ...
                            <div class="row">
                            <div class="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4 well">
                                <span style="font-weight: bold; color: blue; font-style: italic;">Justification for Tablet</span>
                            </div>
                                </div>
                                ...
                                <div id="justificationGroup2" class="col-lg-offset-5 col-md-offset-5">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-5 col-md-5 col-lg-5">
                                            ...
                                            <select id="typrOfUse2" name="typrOfUse2" class="form-control">
                                                <option value="Light">Light</option>
                                                <option value="Medium">Medium</option>
                                                <option value="Heavy">Heavy</option>
                                            </select>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-5 col-md-5 col-lg-5">
                                            ...
                                            <select id="timeWorkedOfCampus2" name="timeWorkedOfCampus2" class="form-control">
                                                <option value="0">0  %</option>
                                                <option value="10">10%</option>
                                                <option value="20">20%</option>
                                                <option value="30">30%</option>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-5 col-md-5 col-lg-5">
                                            ...
                                            <select id="dataUse2" name="dataUse2" class="form-control">
                                                <option value="Light">Light</option>
                                                <option value="Medium">Medium</option>
                                                <option value="Heavy">Heavy</option>
                                            </select>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-5 col-md-5 col-lg-5">
                                            ...
                                            <select id="emailRequired2" name="emailRequired2" class="form-control">
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-5 col-md-5 col-lg-5">
                                            <label class="control-label" style="color: blue;" for="mobilePhoneJustification2">Additional Comments</label>
                                            <input id="mobilePhoneJustification2" name="mobilePhoneJustification2" type="text" placeholder="Enter Justification" class="form-control input-md" data-ng-model="item.mobilePhoneJustification">
                                        </div>
                                    </div>
                                </div>
