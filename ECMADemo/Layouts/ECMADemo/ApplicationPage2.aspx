...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationPage2.aspx.cs" Inherits="ECMADemo.Layouts.ECMADemo.ApplicationPage2" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <% #endif %>
        ...
        <asp:Button ID="btnShowWebName" runat="server" Text="Button" OnClick="getWebTitle()" />
</asp:Content>
